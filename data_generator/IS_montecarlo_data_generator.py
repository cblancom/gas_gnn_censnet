...
class InterconnectedEnergySystemOptimizer:
    ...
    # def modified_vector(self, original_vector):
    #     """
    #     Generates a new vector with values 5% below and 5% above the original vector.

    #     Args:
    #         original_vector (numpy.ndarray): The original vector.

    #     Returns:
    #         numpy.ndarray: A new vector with modified values.
    #     """
    ...
    #     lower_bound = original_vector * (1 - percentage_change)
    #     upper_bound = original_vector * (1 + percentage_change)

    #     # Create the new vector with modified values
    #     modified_vector = np.random.uniform(0, 1, original_vector.shape) * (upper_bound - lower_bound) + lower_bound
    ...
    def extract_data_gas(self, data):
        ...
        # self.loads_gas = self.loads_gas * self.modified_vector(self.loads_gas)
        # self.loads_gas = self.modified_vector(loads_gas)
    ...
    def extract_data_power(self,data):
        ...
        # self.loads_power = self.modified_vector(np.array(self.demand)[:, 0:self.T])
